...
Multiple cohorts/timetables per run (planned later); student-specific availability; timezone handling (all times are local and naive); public holidays; editing individual appointments after generation.
